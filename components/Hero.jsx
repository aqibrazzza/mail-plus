            ...
            <div className="mt-20 md:mt-40">
                <div className="grid grid-cols-5 gap-16 md:grid-cols-8 md:gap-2">
                    <div className="col-span-5 mt-20 space-y-6 md:space-y-10">
                        <h1 className="text-center text-4xl font-bold tracking-tighter text-zinc-900 sm:text-5xl md:text-left lg:text-7xl">
                            Redefine your <br />
                            <span className="text-brand">email experience</span>
                        </h1>
                        <p className="mx-auto max-w-xs text-center text-sm font-light tracking-normal md:mx-0 md:max-w-full md:text-left lg:text-2xl ">
